...
/**
  * This is an event sourced entity. It has a state, [[GreetingState]], which
...
class GreetingEntity extends PersistentEntity {
  ...
  override type Command = GreetingCommand[_]
  ...
  /**
    ...
    */
  override def initialState: GreetingState = GreetingState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case GreetingState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
...
/**
  ...
  */
case class GreetingState(message: String, timestamp: String)
...
/**
  ...
  */
sealed trait GreetingCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends GreetingCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends GreetingCommand[String]
...
/**
  ...
  * application loader.
  */
object GreetingSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[GreetingState]
  )
}
